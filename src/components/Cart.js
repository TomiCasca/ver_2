  ...
  <tbody>
    ...
    <td>{total()}</td>
            ...
            <div id='test5'  align='center'>
                <label label style={{ color: 'black' }}>Ingresa nombre para procesar tu compra:</label>
  <br />
      <input type = 'text' name = 'name'    onChange={evt => onNameChange(evt)} ></input>
  <br />

                <label label style={{ color: 'black' }}>Ingresa Apellido para procesar tu compra:</label>
  <br />
      <input type = 'text' name = 'apellido'    onChange={evt => onApellidoChange(evt)} ></input>
          <br/>

      <label label style={{ color: 'black' }}>Ingresa Fono para procesar tu compra:</label>
  <br />
      <input type = 'text' name = 'phone'    onChange={evt => onPhoneChange(evt)} ></input>
  <br />
      <label label style={{ color: 'black' }}>Ingresa correo para finalizar Compra:</label>
  <br />
                    <input type = 'text' name = 'email'    onChange={evt => onEmailChange(evt)} ></input>
  <br />
      <label label style={{ color: 'black' }}>Ingresa correo nuevamente  para confirmar:</label>
  <br />
